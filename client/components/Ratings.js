    ...
    <Card className={classes.root}>
      <CardActionArea>
        ...
        <CardContent>
          ...
          “Every night of the week we can have something different. It’s like Boop-Boop - You’re done!”
          </Typography>
        </CardContent>
    ...
    <Card className={classes.root}>
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="textSecondary" component="p">
          “We've really been enjoying the meals and there's such a wide selection so that anyone can find something they like. Their customer service is also exceptional!
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          Amy Lexington
                   ...
                   <Typography variant="body2" color="textSecondary" component="p">
          “I love the convenience of delivery, not having to plan the meals or shop. They are easy to make and delicious to eat”
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
